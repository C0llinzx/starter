...
<AccordionGroup>
  <Accordion title="Refused payouts" icon="ban">
  ...
  <Accordion title="Rule changes mid-evaluation" icon="pen-to-square">
  ...
  <Accordion title="Opaque accounting" icon="eye-slash">
  ...
  <Accordion title="The hidden B-book conflict" icon="scale-unbalanced">
  ...
  <Accordion title="Capped scale" icon="arrows-to-line">
...
<Card title="Read the full thesis in the Whitepaper" icon="file-pdf" href="https://hyro.network/whitepaper.pdf" horizontal>
