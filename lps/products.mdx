...
<CardGroup cols={2}>
  <Card title="Individual Trader Vault" icon="user" href="/lps/depositing-withdrawing">
    Concentrated exposure to one trader's PnL. High risk, high upside.
    <br />**Live at launch (Phase 1)**
  </Card>
  <Card title="Hyro Pool" icon="layer-group">
  ...
  <Card title="Tier / Strategy Pools" icon="filter">
    Filtered exposure — e.g. "90%-tier only" or "swing only."
    <br />**Phase 3+**
  </Card>
</CardGroup>

<Card title="$HYRO Staking" icon="coins" href="/token/overview">
