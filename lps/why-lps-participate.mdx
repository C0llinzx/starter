---
title: "Why LPs Participate"
sidebarTitle: "Why LPs Participate"
...
<Warning>
Hyro vaults are a **high-risk allocation**. Returns are tied to live trader PnL — not a fixed yield, not a synthetic basis trade, not a lending APR. Expect drawdowns. See [Risk Disclosure](/lps/risks).
</Warning>
...
<Card title="Explore LP products" icon="layout-grid" href="/lps/vault-types" horizontal>
